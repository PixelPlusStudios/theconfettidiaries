...
const Footer = () => (
  ...
  <footer className="bg-blush py-12 text-center">
    <p className="text-display text-lg font-semibold tracking-[0.15em] text-black">
    ...
    <div className="mt-6 flex justify-center gap-5">
      <a href="https://www.instagram.com/the_confetti_diaries?igsh=MXB6cjBpYmlweGFxeg==" target="_blank" rel="noreferrer">
        <FaInstagram className="h-5 w-5 text-black/60 hover:text-black" />
      </a>

      <a href="https://www.youtube.com/@theconfettidiaries518" target="_blank" rel="noreferrer">
        <FaYoutube className="h-5 w-5 text-black/60 hover:text-black" />
      </a>

      <a href="https://www.facebook.com/share/1AvzGmb6SX/?mibextid=wwXIfr" target="_blank" rel="noreferrer">
        <FaFacebook className="h-5 w-5 text-black/60 hover:text-black" />
      </a>
    </div>
